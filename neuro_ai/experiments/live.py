...
class DataProcessig:
    ...
    def append_wave_avg(self, a, b, t, g):
        ...
        self.wave_data["waves_avg"]["alpha"] = self.wave_data["waves_avg"]["alpha"][
            -self.len_wave_hist :
        ]
        self.wave_data["waves_avg"]["beta"].append(b)
        self.wave_data["waves_avg"]["beta"] = self.wave_data["waves_avg"]["beta"][
            -self.len_wave_hist :
        ]
        self.wave_data["waves_avg"]["theta"].append(t)
        self.wave_data["waves_avg"]["theta"] = self.wave_data["waves_avg"]["theta"][
            -self.len_wave_hist :
        ]
        self.wave_data["waves_avg"]["gamma"].append(g)
        self.wave_data["waves_avg"]["gamma"] = self.wave_data["waves_avg"]["gamma"][
            -self.len_wave_hist :
        ]
    ...
    def process_data(self, board_shim, graphs=None):
        ...
        self.append_wave_avg(
            mean_alpha_power, mean_beta_power, mean_theta_power, mean_gamma_power
        )

        graphs.graphs["Test1"].update(
            [self.wave_data["waves_avg"]["alpha"], self.wave_data["waves_avg"]["beta"]]
        )
